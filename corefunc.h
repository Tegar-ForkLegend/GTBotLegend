...
int START_DARI = 1;
//acc password
string Password_acc = "@subzaqx123";
//acc username
string Growid_acc = "ZaqxKunC";
		...
		if (packet) {
	    	...
	    	if (extended) {
	    		...
	    		START_DARI = START_DARI + 1;
	    				...
	    				cout << "©ZaqxKun: Success Make Account GrowID: " << growid << ", Password: " << Password_acc << endl;
